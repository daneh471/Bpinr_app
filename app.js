...
const translations = {
  sk: {
    ...
    updateReady: "Nová verzia (v2.23) je pripravená:",
    updateChanges: "• FIX: Opravená responzivita hlavičky, aby sa názov správne skrátil na úzkych obrazovkách.",
  ...
  de: {
    ...
    updateReady: "Neue Version (v2.23) ist bereit:",
    updateChanges: "• FIX: Header-Responsivität korrigiert, damit der Titel auf schmalen Bildschirmen korrekt gekürzt wird.",
...
if ('serviceWorker' in navigator) {
  ...
  navigator.serviceWorker.register('./sw.js?v=2.23').then(reg => {
