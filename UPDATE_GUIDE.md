...
## Zmeny v tejto verzii (v2.08):
- ✅ PWA: Odstránené 404 chyby chýbajúcich ikon, ktoré kriticky zhadzovali inštaláciu.
- ✅ PWA: Pridané nové meta tagy pre bezchybnú podporu mobilných zariadení.
...
git add .
git commit -m "Update v2.08: Fix missing PWA icons and Service Worker scope causing 404s"
