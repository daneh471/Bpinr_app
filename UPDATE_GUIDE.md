...
## Zmeny v tejto verzii (v2.39):
- ✅ **UI:** Vylepšenie tmavého režimu (true black) a zjednotenie farby systémových líšt.
...
git add .
git commit -m "Release v2.39: UI improvements (true black theme)"
