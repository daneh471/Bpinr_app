...
## Zmeny v tejto verzii (v2.23):
- ✅ **FIX:** Opravená responzivita hlavičky, aby sa názov správne skrátil na úzkych obrazovkách.
...
git add .
git commit -m "Release v2.23: Fix header title responsiveness"
